import { FaLeaf, FaFire, FaWater, FaBolt, FaSnowflake, FaFistRaised, FaSkullCrossbones, FaHeart, FaWrench, FaBug, FaMountain, FaGhost, FaDragon, FaMask, FaShieldAlt, FaMagic, FaFantasyFlightGames } from "react-icons/fa"; // Importez les icônes correspondantes
...
const formatPokemonId = (id) => `#${id.toString().padStart(3, "0")}`;
  ...
  export { typeColors,types, typeIcons, capitalizeFirstLetter, convertHeight, convertWeight, formatPokemonId, playSound };
